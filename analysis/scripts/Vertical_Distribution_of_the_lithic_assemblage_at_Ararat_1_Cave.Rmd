...
```{r warning=FALSE}
# Load the dataset
data_path <- "C:\\Users\\David\\OneDrive - huji.ac.il\\Desktop\\Archaeology\\Publications\\In_Proguess\\PhD\\QSR\\Ararat_1_cave_lithic_analysis\\Raw data\\Lithic_Attribute_Analysis_Ararat_1_CaveQSR.xlsx"
...
```{r}
# Save the plots
ggsave("C:\\Users\\David\\OneDrive - huji.ac.il\\Desktop\\Archaeology\\Publications\\In_Proguess\\PhD\\QSR\\Ararat1caveLithicQSR\\analysis\\data\\derived data\\Plot1_Bottom_Elevation)L_W.png", plot = Plot1, width = 8, height = 10, dpi = 300, bg = 'white')

ggsave("C:\\Users\\David\\OneDrive - huji.ac.il\\Desktop\\Archaeology\\Publications\\In_Proguess\\PhD\\QSR\\Ararat_1_cave_lithic_analysis\\Derived data\\Plot2_Bottom_Elevation)app_size.png", plot = Plot2, width = 8, height = 10, dpi = 300, bg = 'white')
```
